...
-- ============================================================
-- LABELS TABLE
-- Quality labels for activity records, generated by the local
-- scorer and optionally refined by HuggingFace classification.
...
CREATE TABLE IF NOT EXISTS labels (
  ...
  -- Source: the labeller DID/identifier that issued this label
...
-- Enriched label columns (added for local scoring)
ALTER TABLE labels ADD COLUMN IF NOT EXISTS subject_uri TEXT;
ALTER TABLE labels ADD COLUMN IF NOT EXISTS score INTEGER;
ALTER TABLE labels ADD COLUMN IF NOT EXISTS breakdown JSONB;
ALTER TABLE labels ADD COLUMN IF NOT EXISTS test_signals JSONB;
ALTER TABLE labels ADD COLUMN IF NOT EXISTS hf_label TEXT;
ALTER TABLE labels ADD COLUMN IF NOT EXISTS hf_score REAL;
...
-- Lookup by subject URI (for per-activity label queries)
