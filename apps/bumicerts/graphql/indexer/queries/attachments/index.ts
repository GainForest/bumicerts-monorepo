...
import type { BlobLike, StrongRefLike } from "../_migration-helpers";
import {
  connectionPageInfo,
  normalizeBskyFacets,
...
type AttachmentNode = ConnectionNode<
  ResultOf<typeof byDidDocument>["orgHypercertsContextAttachment"]
>;
