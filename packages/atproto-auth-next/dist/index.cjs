...
__export(src_exports, {
  DEFAULT_OAUTH_SCOPE: () => DEFAULT_OAUTH_SCOPE,
  NodeOAuthClient: () => import_oauth_client_node.NodeOAuthClient,
...
function createLogoutHandler(client, sessionConfig, options = {}) {
  return async function POST() {
    ...
    if (options.redirectTo) {
      return import_server.NextResponse.redirect(options.redirectTo);
    }
