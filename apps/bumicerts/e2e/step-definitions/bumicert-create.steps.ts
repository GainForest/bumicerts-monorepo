 ...
 */
Given('I am on step {int} of bumicert creation', async function (this: AppWorld, stepNumber: number) {
  const page = getPage(this)
 ...
 */
When('the user clicks {string}', async function (this: AppWorld, buttonText: string) {
  const page = getPage(this)
 ...
 */
Then('the user should be on step {int}', async function (this: AppWorld, stepNumber: number) {
  const page = getPage(this)
 ...
 */
When('the user enters bumicert title {string}', async function (this: AppWorld, title: string) {
  const page = getPage(this)
 ...
 */
When('the user enters impact story {string}', async function (this: AppWorld, story: string) {
  const page = getPage(this)
  
  // The Leaflet editor uses ProseMirror
  const editor = page.locator('.leaflet-editor__content .ProseMirror').first()
  await editor.click()
 ...
 */
When('the user enters short description {string}', async function (this: AppWorld, description: string) {
  const page = getPage(this)
 ...
 */
When('the user adds themselves as a contributor', async function (this: AppWorld) {
  const page = getPage(this)
 ...
 */
Then('the user should see the review page with all sections complete', async function (this: AppWorld) {
  const page = getPage(this)
 ...
 */
Then('the bumicert should be published successfully', async function (this: AppWorld) {
  const page = getPage(this)
 ...
 */
Then('the user should see the success message', async function (this: AppWorld) {
  const page = getPage(this)
  ...
  const viewButton = page.locator('a:has-text("View Bumicert")').or(
    page.locator('button:has-text("View Bumicert")')
  )
...
When('the user saves the draft', async function (this: AppWorld) {
  ...
  const confirmButton = page.locator('button:has-text("Save")').or(
 ...
 */
Then('the user should see their draft in the list', async function (this: AppWorld) {
  const page = getPage(this)
  
  // On the /bumicert/create page, look for the drafts list
  // The DraftBumicerts component shows "Pending Applications"
  
  const draftsList = page.locator('text=/Pending Applications|Your Drafts/i')
...
When('the user clicks on their first draft', async function (this: AppWorld) {
  ...
  const firstDraft = page.locator('[data-testid="draft-item"]').or(
    page.locator('a[href*="/bumicert/create/"]').or(
      page.locator('button').filter({ hasText: /Draft|Test/ })
    )
  ).first()
 ...
 */
Then('the bumicert title should contain {string}', async function (this: AppWorld, expectedText: string) {
  const page = getPage(this)
